...
const _abi = [
  {
    ...
    name: "DailyWithdrawalMaxQuotasUpdated",
    type: "event",
  },
  {
    anonymous: false,
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        indexed: false,
        internalType: "address[]",
        name: "crossbellTokens",
        type: "address[]",
      },
      {
        indexed: false,
        internalType: "uint8[]",
        name: "crossbellTokenDecimals",
        type: "uint8[]",
      },
    ],
    name: "TokenMapped",
    ...
    outputs: [
      {
        ...
        internalType: "struct DataTypes.MappedToken",
        name: "token",
        type: "tuple",
      },
    ],
  ...
  },
  {
    ...
    name: "getDailyWithdrawalMaxQuota",
    outputs: [
      {
        internalType: "uint256",
        name: "",
  ...
  },
  {
    ...
    name: "getDailyWithdrawalRemainingQuota",
    outputs: [
      {
        internalType: "uint256",
        name: "",
  ...
  },
  {
    ...
    name: "setDailyWithdrawalMaxQuotas",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  ...
  },
  {
    inputs: [
      ...
      },
      {
        ...
        internalType: "struct DataTypes.Signature[]",
        name: "signatures",
        type: "tuple[]",
      },
    ],
